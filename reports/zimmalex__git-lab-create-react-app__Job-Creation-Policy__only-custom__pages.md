...
We found that [.gitlab-ci.yml](https://gitlab.com/zimmalex/git-lab-create-react-app/blob/master/.gitlab-ci.yml) contains a violation of the following CI/CD principle:
