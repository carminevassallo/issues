...
We found that [.gitlab-ci.yml](https://gitlab.com/andrewbanchich/stellar-jekyll-theme/blob/master/.gitlab-ci.yml) contains a violation of the following CI/CD principle:
