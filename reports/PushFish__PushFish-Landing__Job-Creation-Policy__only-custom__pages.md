...
We found that [.gitlab-ci.yml](https://gitlab.com/PushFish/PushFish-Landing/blob/master/.gitlab-ci.yml) contains a violation of the following CI/CD principle:
