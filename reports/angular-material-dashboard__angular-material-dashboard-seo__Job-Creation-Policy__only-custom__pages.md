...
We found that [.gitlab-ci.yml](https://gitlab.com/angular-material-dashboard/angular-material-dashboard-seo/blob/master/.gitlab-ci.yml) contains a violation of the following CI/CD principle:
