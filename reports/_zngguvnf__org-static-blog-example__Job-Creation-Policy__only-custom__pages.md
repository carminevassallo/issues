...
We found that [.gitlab-ci.yml](https://gitlab.com/_zngguvnf/org-static-blog-example/blob/master/.gitlab-ci.yml) contains a violation of the following CI/CD principle:
