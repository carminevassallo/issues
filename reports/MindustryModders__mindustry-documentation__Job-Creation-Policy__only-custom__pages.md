...
We found that [.gitlab-ci.yml](https://gitlab.com/MindustryModders/mindustry-documentation/blob/master/.gitlab-ci.yml) contains a violation of the following CI/CD principle:
