...
* org-apache-maven-plugins-maven-failsafe-plugin (line )

> **Suggested Fix:** Specify the exact version of dependency `org-apache-maven-plugins-maven-failsafe-plugin`.
