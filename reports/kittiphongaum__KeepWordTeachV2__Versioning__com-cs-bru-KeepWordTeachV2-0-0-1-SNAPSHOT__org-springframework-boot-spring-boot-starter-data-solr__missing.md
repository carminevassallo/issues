...
* org-springframework-boot-spring-boot-starter-data-solr (line )

> **Suggested Fix:** Specify the exact version of dependency `org-springframework-boot-spring-boot-starter-data-solr`.
