...
We found that [.gitlab-ci.yml](https://gitlab.com/mexus/rustup-components-availability/blob/master/.gitlab-ci.yml) contains a violation of the following CI/CD principle:
