...
* org-jboss-spec-javax-json-jboss-json-api_1-0_spec (line )

> **Suggested Fix:** Specify the exact version of dependency `org-jboss-spec-javax-json-jboss-json-api_1-0_spec`.
