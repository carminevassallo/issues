...
* org-glassfish-jersey-test-framework-providers-jersey-test-framework-provider-jdk-http (line )

> **Suggested Fix:** Specify the exact version of dependency `org-glassfish-jersey-test-framework-providers-jersey-test-framework-provider-jdk-http`.
