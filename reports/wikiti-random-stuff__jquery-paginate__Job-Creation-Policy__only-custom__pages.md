...
We found that [.gitlab-ci.yml](https://gitlab.com/wikiti-random-stuff/jquery-paginate/blob/master/.gitlab-ci.yml) contains a violation of the following CI/CD principle:
