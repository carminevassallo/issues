...
We found that [.gitlab-ci.yml](https://gitlab.com/PrajjwalDimri/itg-cse-web-tech/blob/master/.gitlab-ci.yml) contains a violation of the following CI/CD principle:
