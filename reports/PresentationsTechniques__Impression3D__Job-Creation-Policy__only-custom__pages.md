...
We found that [.gitlab-ci.yml](https://gitlab.com/PresentationsTechniques/Impression3D/blob/master/.gitlab-ci.yml) contains a violation of the following CI/CD principle:
