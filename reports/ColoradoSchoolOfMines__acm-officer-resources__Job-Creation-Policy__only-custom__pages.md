...
We found that [.gitlab-ci.yml](https://gitlab.com/ColoradoSchoolOfMines/acm-officer-resources/blob/master/.gitlab-ci.yml) contains a violation of the following CI/CD principle:
