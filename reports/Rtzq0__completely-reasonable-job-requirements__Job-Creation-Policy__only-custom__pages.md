...
We found that [.gitlab-ci.yml](https://gitlab.com/Rtzq0/completely-reasonable-job-requirements/blob/master/.gitlab-ci.yml) contains a violation of the following CI/CD principle:
