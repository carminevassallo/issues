...
Job minimal_systemd_vm_aarch64 is manually triggered
...
Job `minimal_systemd_vm_aarch64`, that is defined at line  and executed in stage ``, is set to be executed manually.
...
> **Suggested Fix:** Remove ```when:manual``` from the definition of job `minimal_systemd_vm_aarch64`.
