...
We found that [.gitlab-ci.yml](https://gitlab.com/rogerclotet/amicinvisible-server/blob/master/.gitlab-ci.yml) contains a violation of the following CI/CD principle:
