...
We found that [.gitlab-ci.yml](https://gitlab.com/homes-made-simple/hms-website/blob/master/.gitlab-ci.yml) contains a violation of the following CI/CD principle:
