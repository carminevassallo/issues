...
We found that [.gitlab-ci.yml](https://gitlab.com/ae-dir/python-aedir/blob/master/.gitlab-ci.yml) contains a violation of the following CI/CD principle:
...
Job `-tests`, that is defined at line , is set to  be created in stage `` if developers commit changes with some tags
