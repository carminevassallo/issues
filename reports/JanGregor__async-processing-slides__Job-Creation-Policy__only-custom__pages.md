...
We found that [.gitlab-ci.yml](https://gitlab.com/JanGregor/async-processing-slides/blob/master/.gitlab-ci.yml) contains a violation of the following CI/CD principle:
