...
Job bins is not created when certain new commits are pushed.
...
Job `bins`, that is defined at line , is set to  be created in stage `` if developers commit changes to some branches
