...
We found that [.gitlab-ci.yml](https://gitlab.com/jonas_jostmann/oer-meltdown/blob/master/.gitlab-ci.yml) contains a violation of the following CI/CD principle:
