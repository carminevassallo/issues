...
We found that [.gitlab-ci.yml](https://gitlab.com/librespacefoundation/gr-leo/blob/master/.gitlab-ci.yml) contains a violation of the following CI/CD principle:
