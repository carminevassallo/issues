...
* git-https---gitlab-com-coala-coala-utils-egg-coala-utils (line )

> **Suggested Fix:** Specify the exact version of dependency `git-https---gitlab-com-coala-coala-utils-egg-coala-utils`.
