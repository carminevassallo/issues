...
We found that [.gitlab-ci.yml](https://gitlab.com/aswinshenoy/inctf-from-bs4/blob/master/.gitlab-ci.yml) contains a violation of the following CI/CD principle:
