...
We found that [.gitlab-ci.yml](https://gitlab.com/msaby/atelier-openrefine-MASA/blob/master/.gitlab-ci.yml) contains a violation of the following CI/CD principle:
