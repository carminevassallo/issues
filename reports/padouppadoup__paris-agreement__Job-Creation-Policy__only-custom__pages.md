...
We found that [.gitlab-ci.yml](https://gitlab.com/padouppadoup/paris-agreement/blob/master/.gitlab-ci.yml) contains a violation of the following CI/CD principle:
