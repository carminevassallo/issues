...
* org-springframework-security-spring-security-messaging (line )

> **Suggested Fix:** Specify the exact version of dependency `org-springframework-security-spring-security-messaging`.
