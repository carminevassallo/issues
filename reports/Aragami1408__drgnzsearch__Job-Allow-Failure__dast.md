...
> **Suggested Fix:** Modify ```allow_failure: true``` with ```allow_failure: false``` for job `dast` in [.gitlab-ci.yml](https://gitlab.com/Aragami1408/drgnzsearch/blob/master/.gitlab-ci.yml)
