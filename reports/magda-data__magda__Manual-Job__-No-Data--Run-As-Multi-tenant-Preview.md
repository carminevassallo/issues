...
Job -No-Data--Run-As-Multi-tenant-Preview is manually triggered
...
Job `-No-Data--Run-As-Multi-tenant-Preview`, that is defined at line  and executed in stage ``, is set to be executed manually.
...
> **Suggested Fix:** Remove ```when:manual``` from the definition of job `-No-Data--Run-As-Multi-tenant-Preview`.
