...
We found that [.gitlab-ci.yml](https://gitlab.com/jkantarek/kafka_ex_helpers/blob/master/.gitlab-ci.yml) contains a violation of the following CI/CD principle:
