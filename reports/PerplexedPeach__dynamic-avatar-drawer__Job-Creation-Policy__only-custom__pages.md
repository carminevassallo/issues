...
We found that [.gitlab-ci.yml](https://gitlab.com/PerplexedPeach/dynamic-avatar-drawer/blob/master/.gitlab-ci.yml) contains a violation of the following CI/CD principle:
