...
We found that [.gitlab-ci.yml](https://gitlab.com/VickySteeves/lis-628-datalibrarianship/blob/master/.gitlab-ci.yml) contains a violation of the following CI/CD principle:
