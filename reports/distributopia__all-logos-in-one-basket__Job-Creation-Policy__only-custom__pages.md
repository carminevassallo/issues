...
We found that [.gitlab-ci.yml](https://gitlab.com/distributopia/all-logos-in-one-basket/blob/master/.gitlab-ci.yml) contains a violation of the following CI/CD principle:
