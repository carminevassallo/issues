...
We found that [.gitlab-ci.yml](https://gitlab.com/karel-houf/react-face-detection/blob/master/.gitlab-ci.yml) contains a violation of the following CI/CD principle:
