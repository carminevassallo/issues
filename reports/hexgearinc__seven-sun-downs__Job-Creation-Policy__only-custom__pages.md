...
We found that [.gitlab-ci.yml](https://gitlab.com/hexgearinc/seven-sun-downs/blob/master/.gitlab-ci.yml) contains a violation of the following CI/CD principle:
