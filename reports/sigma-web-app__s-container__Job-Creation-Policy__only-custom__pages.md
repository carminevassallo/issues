...
We found that [.gitlab-ci.yml](https://gitlab.com/sigma-web-app/s-container/blob/master/.gitlab-ci.yml) contains a violation of the following CI/CD principle:
