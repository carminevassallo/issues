...
We found that [.gitlab-ci.yml](https://gitlab.com/jum-s/understanding_linked_geodata/blob/master/.gitlab-ci.yml) contains a violation of the following CI/CD principle:
