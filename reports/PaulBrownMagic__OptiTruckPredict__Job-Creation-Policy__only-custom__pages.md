...
We found that [.gitlab-ci.yml](https://gitlab.com/PaulBrownMagic/OptiTruckPredict/blob/master/.gitlab-ci.yml) contains a violation of the following CI/CD principle:
