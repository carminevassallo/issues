...
We found that [.gitlab-ci.yml](https://gitlab.com/MatiAedo/club-de-la-lucha/blob/master/.gitlab-ci.yml) contains a violation of the following CI/CD principle:
