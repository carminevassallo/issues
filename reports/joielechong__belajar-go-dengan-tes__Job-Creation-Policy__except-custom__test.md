...
We found that [.gitlab-ci.yml](https://gitlab.com/joielechong/belajar-go-dengan-tes/blob/master/.gitlab-ci.yml) contains a violation of the following CI/CD principle:
