...
We found that [.gitlab-ci.yml](https://gitlab.com/andybalaam/cross-the-road/blob/master/.gitlab-ci.yml) contains a violation of the following CI/CD principle:
