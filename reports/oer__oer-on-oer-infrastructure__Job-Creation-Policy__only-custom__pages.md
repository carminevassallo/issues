...
We found that [.gitlab-ci.yml](https://gitlab.com/oer/oer-on-oer-infrastructure/blob/master/.gitlab-ci.yml) contains a violation of the following CI/CD principle:
