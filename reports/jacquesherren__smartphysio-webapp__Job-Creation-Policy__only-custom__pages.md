...
We found that [.gitlab-ci.yml](https://gitlab.com/jacquesherren/smartphysio-webapp/blob/master/.gitlab-ci.yml) contains a violation of the following CI/CD principle:
