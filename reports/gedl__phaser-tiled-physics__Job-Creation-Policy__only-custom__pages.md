...
We found that [.gitlab-ci.yml](https://gitlab.com/gedl/phaser-tiled-physics/blob/master/.gitlab-ci.yml) contains a violation of the following CI/CD principle:
