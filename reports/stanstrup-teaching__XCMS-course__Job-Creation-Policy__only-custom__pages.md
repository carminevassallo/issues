...
We found that [.gitlab-ci.yml](https://gitlab.com/stanstrup-teaching/XCMS-course/blob/master/.gitlab-ci.yml) contains a violation of the following CI/CD principle:
