...
* io-vertx-vertx-service-discovery-bridge-kubernetes (line )

> **Suggested Fix:** Specify the exact version of dependency `io-vertx-vertx-service-discovery-bridge-kubernetes`.
