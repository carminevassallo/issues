...
We found that [.gitlab-ci.yml](https://gitlab.com/CruAlbaniaDigital/broshura-4-ligjet/blob/master/.gitlab-ci.yml) contains a violation of the following CI/CD principle:
