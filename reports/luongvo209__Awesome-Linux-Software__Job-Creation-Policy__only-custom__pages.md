...
We found that [.gitlab-ci.yml](https://gitlab.com/luongvo209/Awesome-Linux-Software/blob/master/.gitlab-ci.yml) contains a violation of the following CI/CD principle:
