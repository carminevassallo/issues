...
We found that [.gitlab-ci.yml](https://gitlab.com/IonicZoo/eagle-map-component/blob/master/.gitlab-ci.yml) contains a violation of the following CI/CD principle:
