...
We found that [.gitlab-ci.yml](https://gitlab.com/jasonmm/baseball-stats-db/blob/master/.gitlab-ci.yml) contains a violation of the following CI/CD principle:
