...
We found that [.gitlab-ci.yml](https://gitlab.com/JohnBlood/project-trident/blob/master/.gitlab-ci.yml) contains a violation of the following CI/CD principle:
