...
Job MacOS is not created when certain new commits are pushed.
...
Job `MacOS`, that is defined at line , is set to not be created in stage `` if developers commit changes to some branches
