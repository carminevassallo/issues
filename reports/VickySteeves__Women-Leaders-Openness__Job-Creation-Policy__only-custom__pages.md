...
We found that [.gitlab-ci.yml](https://gitlab.com/VickySteeves/Women-Leaders-Openness/blob/master/.gitlab-ci.yml) contains a violation of the following CI/CD principle:
