...
We found that [.gitlab-ci.yml](https://gitlab.com/radiognu/radiognu-widget-legacy/blob/master/.gitlab-ci.yml) contains a violation of the following CI/CD principle:
