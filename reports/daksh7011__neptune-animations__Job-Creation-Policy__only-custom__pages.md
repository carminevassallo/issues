...
We found that [.gitlab-ci.yml](https://gitlab.com/daksh7011/neptune-animations/blob/master/.gitlab-ci.yml) contains a violation of the following CI/CD principle:
