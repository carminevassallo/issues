...
We found that [.gitlab-ci.yml](https://gitlab.com/swe-nrb/sbp-begreppslista/blob/master/.gitlab-ci.yml) contains a violation of the following CI/CD principle:
