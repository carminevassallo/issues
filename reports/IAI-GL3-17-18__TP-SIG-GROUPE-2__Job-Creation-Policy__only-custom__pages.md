...
We found that [.gitlab-ci.yml](https://gitlab.com/IAI-GL3-17-18/TP-SIG-GROUPE-2/blob/master/.gitlab-ci.yml) contains a violation of the following CI/CD principle:
