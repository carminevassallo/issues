...
Job cmake_build is not created when certain new commits are pushed.
...
Job `cmake_build`, that is defined at line , is set to  be created in stage `` if developers commit changes to some branches
