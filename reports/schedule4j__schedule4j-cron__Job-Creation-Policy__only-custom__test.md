...
We found that [.gitlab-ci.yml](https://gitlab.com/schedule4j/schedule4j-cron/blob/master/.gitlab-ci.yml) contains a violation of the following CI/CD principle:
