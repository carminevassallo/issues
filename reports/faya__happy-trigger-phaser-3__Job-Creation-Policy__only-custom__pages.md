...
We found that [.gitlab-ci.yml](https://gitlab.com/faya/happy-trigger-phaser-3/blob/master/.gitlab-ci.yml) contains a violation of the following CI/CD principle:
