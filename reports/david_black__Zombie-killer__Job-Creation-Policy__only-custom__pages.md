...
We found that [.gitlab-ci.yml](https://gitlab.com/david_black/Zombie-killer/blob/master/.gitlab-ci.yml) contains a violation of the following CI/CD principle:
