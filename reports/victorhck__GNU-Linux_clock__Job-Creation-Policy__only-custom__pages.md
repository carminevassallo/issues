...
We found that [.gitlab-ci.yml](https://gitlab.com/victorhck/GNU-Linux_clock/blob/master/.gitlab-ci.yml) contains a violation of the following CI/CD principle:
