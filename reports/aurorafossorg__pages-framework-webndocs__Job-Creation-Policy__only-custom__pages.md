...
We found that [.gitlab-ci.yml](https://gitlab.com/aurorafossorg/pages-framework-webndocs/blob/master/.gitlab-ci.yml) contains a violation of the following CI/CD principle:
