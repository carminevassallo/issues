...
We found that [.gitlab-ci.yml](https://gitlab.com/VincentTam/test-hugo-staticman/blob/master/.gitlab-ci.yml) contains a violation of the following CI/CD principle:
