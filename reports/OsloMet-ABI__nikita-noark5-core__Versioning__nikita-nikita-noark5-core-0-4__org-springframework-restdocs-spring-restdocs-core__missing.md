...
* org-springframework-restdocs-spring-restdocs-core (line )

> **Suggested Fix:** Specify the exact version of dependency `org-springframework-restdocs-spring-restdocs-core`.
