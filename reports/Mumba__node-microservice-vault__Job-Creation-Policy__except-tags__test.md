...
We found that [.gitlab-ci.yml](https://gitlab.com/Mumba/node-microservice-vault/blob/master/.gitlab-ci.yml) contains a violation of the following CI/CD principle:
