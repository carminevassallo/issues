...
We found that [.gitlab-ci.yml](https://gitlab.com/frontendne/devs-against-humanity/blob/master/.gitlab-ci.yml) contains a violation of the following CI/CD principle:
