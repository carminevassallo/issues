...
We found that [.gitlab-ci.yml](https://gitlab.com/foxnewsnetwork/ember-gitlab-pages/blob/master/.gitlab-ci.yml) contains a violation of the following CI/CD principle:
