...
We found that [.gitlab-ci.yml](https://gitlab.com/tuomashatakka/atom-ui-reduced-dark/blob/master/.gitlab-ci.yml) contains a violation of the following CI/CD principle:
