...
We found that [.gitlab-ci.yml](https://gitlab.com/lorepirri/jekyll-theme-simple-blog/blob/master/.gitlab-ci.yml) contains a violation of the following CI/CD principle:
