...
Job Digital-Ocean is not created when certain new commits are pushed.
...
Job `Digital-Ocean`, that is defined at line , is set to  be created in stage `` if developers commit changes with some tags
