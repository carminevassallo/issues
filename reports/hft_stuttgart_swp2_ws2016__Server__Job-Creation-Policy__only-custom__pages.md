...
We found that [.gitlab-ci.yml](https://gitlab.com/hft_stuttgart_swp2_ws2016/Server/blob/master/.gitlab-ci.yml) contains a violation of the following CI/CD principle:
