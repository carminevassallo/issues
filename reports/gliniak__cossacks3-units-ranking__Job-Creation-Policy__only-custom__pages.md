...
We found that [.gitlab-ci.yml](https://gitlab.com/gliniak/cossacks3-units-ranking/blob/master/.gitlab-ci.yml) contains a violation of the following CI/CD principle:
