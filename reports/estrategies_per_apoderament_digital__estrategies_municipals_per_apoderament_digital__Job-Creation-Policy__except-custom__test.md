...
We found that [.gitlab-ci.yml](https://gitlab.com/estrategies_per_apoderament_digital/estrategies_municipals_per_apoderament_digital/blob/master/.gitlab-ci.yml) contains a violation of the following CI/CD principle:
...
Job `test`, that is defined at line , is set to not be created in stage `` if developers commit changes with the following refs:
