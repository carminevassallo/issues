...
We found that [.gitlab-ci.yml](https://gitlab.com/winniehell/file-name-linter/blob/master/.gitlab-ci.yml) contains a violation of the following CI/CD principle:
