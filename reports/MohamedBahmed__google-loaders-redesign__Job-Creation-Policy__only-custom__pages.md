...
We found that [.gitlab-ci.yml](https://gitlab.com/MohamedBahmed/google-loaders-redesign/blob/master/.gitlab-ci.yml) contains a violation of the following CI/CD principle:
