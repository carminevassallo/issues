...
We found that [.gitlab-ci.yml](https://gitlab.com/loppear/social-coop-policies/blob/master/.gitlab-ci.yml) contains a violation of the following CI/CD principle:
