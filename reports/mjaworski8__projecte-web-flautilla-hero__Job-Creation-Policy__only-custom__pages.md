...
We found that [.gitlab-ci.yml](https://gitlab.com/mjaworski8/projecte-web-flautilla-hero/blob/master/.gitlab-ci.yml) contains a violation of the following CI/CD principle:
