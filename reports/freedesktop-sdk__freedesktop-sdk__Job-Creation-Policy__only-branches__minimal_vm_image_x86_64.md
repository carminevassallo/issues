...
Job minimal_vm_image_x86_64 is not created when certain new commits are pushed.
...
Job `minimal_vm_image_x86_64`, that is defined at line , is set to  be created in stage `` if developers commit changes to some branches
