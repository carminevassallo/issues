...
Job publish_snap_arm is manually triggered
...
Job `publish_snap_arm`, that is defined at line  and executed in stage ``, is set to be executed manually.
...
> **Suggested Fix:** Remove ```when:manual``` from the definition of job `publish_snap_arm`.
