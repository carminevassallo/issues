...
We found that [.gitlab-ci.yml](https://gitlab.com/SumNeuron/cookie-cutter-rollup-vue/blob/master/.gitlab-ci.yml) contains a violation of the following CI/CD principle:
