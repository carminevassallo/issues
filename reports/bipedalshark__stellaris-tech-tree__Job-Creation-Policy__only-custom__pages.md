...
We found that [.gitlab-ci.yml](https://gitlab.com/bipedalshark/stellaris-tech-tree/blob/master/.gitlab-ci.yml) contains a violation of the following CI/CD principle:
