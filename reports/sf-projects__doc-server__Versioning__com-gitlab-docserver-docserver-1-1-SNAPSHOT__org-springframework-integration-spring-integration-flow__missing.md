...
* org-springframework-integration-spring-integration-flow (line )

> **Suggested Fix:** Specify the exact version of dependency `org-springframework-integration-spring-integration-flow`.
