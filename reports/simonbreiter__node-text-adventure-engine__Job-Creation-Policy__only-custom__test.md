...
We found that [.gitlab-ci.yml](https://gitlab.com/simonbreiter/node-text-adventure-engine/blob/master/.gitlab-ci.yml) contains a violation of the following CI/CD principle:
