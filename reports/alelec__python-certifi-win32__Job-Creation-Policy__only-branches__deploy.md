...
We found that [.gitlab-ci.yml](https://gitlab.com/alelec/python-certifi-win32/blob/master/.gitlab-ci.yml) contains a violation of the following CI/CD principle:
