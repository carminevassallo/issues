...
We found that [.gitlab-ci.yml](https://gitlab.com/scastiel/protonmail-theme-creator/blob/master/.gitlab-ci.yml) contains a violation of the following CI/CD principle:
