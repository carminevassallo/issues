...
We found that [.gitlab-ci.yml](https://gitlab.com/dunossauro/do-zero-ao-deploy/blob/master/.gitlab-ci.yml) contains a violation of the following CI/CD principle:
