...
We found that [.gitlab-ci.yml](https://gitlab.com/9000-volts/pages-md-parse/blob/master/.gitlab-ci.yml) contains a violation of the following CI/CD principle:
