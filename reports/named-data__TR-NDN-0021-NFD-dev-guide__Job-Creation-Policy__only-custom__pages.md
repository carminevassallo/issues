...
We found that [.gitlab-ci.yml](https://gitlab.com/named-data/TR-NDN-0021-NFD-dev-guide/blob/master/.gitlab-ci.yml) contains a violation of the following CI/CD principle:
