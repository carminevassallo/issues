...
We found that [.gitlab-ci.yml](https://gitlab.com/clear-code/lua-web-driver/blob/master/.gitlab-ci.yml) contains a violation of the following CI/CD principle:
