...
We found that [.gitlab-ci.yml](https://gitlab.com/leipert-projects/gitlab-history/blob/master/.gitlab-ci.yml) contains a violation of the following CI/CD principle:
