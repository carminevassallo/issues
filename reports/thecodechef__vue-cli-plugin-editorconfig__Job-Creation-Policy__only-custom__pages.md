...
We found that [.gitlab-ci.yml](https://gitlab.com/thecodechef/vue-cli-plugin-editorconfig/blob/master/.gitlab-ci.yml) contains a violation of the following CI/CD principle:
