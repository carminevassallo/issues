...
> **Suggested Fix:** Modify ```allow_failure: true``` with ```allow_failure: false``` for job `connected-27-google_apis_playstore-x86` in [.gitlab-ci.yml](https://gitlab.com/fdroid/fdroidclient/blob/master/.gitlab-ci.yml)
