...
We found that [.gitlab-ci.yml](https://gitlab.com/node-microservice/microservice/blob/master/.gitlab-ci.yml) contains a violation of the following CI/CD principle:
