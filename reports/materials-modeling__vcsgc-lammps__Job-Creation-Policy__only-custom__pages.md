...
We found that [.gitlab-ci.yml](https://gitlab.com/materials-modeling/vcsgc-lammps/blob/master/.gitlab-ci.yml) contains a violation of the following CI/CD principle:
