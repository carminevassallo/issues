...
Job minimal_systemd_vm_powerpc64le is manually triggered
...
Job `minimal_systemd_vm_powerpc64le`, that is defined at line  and executed in stage ``, is set to be executed manually.
...
> **Suggested Fix:** Remove ```when:manual``` from the definition of job `minimal_systemd_vm_powerpc64le`.
