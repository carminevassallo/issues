...
We found that [.gitlab-ci.yml](https://gitlab.com/kollavarsham/smc-webfonts/blob/master/.gitlab-ci.yml) contains a violation of the following CI/CD principle:
