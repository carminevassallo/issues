...
We found that [.gitlab-ci.yml](https://gitlab.com/amritpandey/the-c-programming-language/blob/master/.gitlab-ci.yml) contains a violation of the following CI/CD principle:
