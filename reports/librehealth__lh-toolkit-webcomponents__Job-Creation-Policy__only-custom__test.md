...
We found that [.gitlab-ci.yml](https://gitlab.com/librehealth/lh-toolkit-webcomponents/blob/master/.gitlab-ci.yml) contains a violation of the following CI/CD principle:
