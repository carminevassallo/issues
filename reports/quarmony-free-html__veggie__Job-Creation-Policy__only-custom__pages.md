...
We found that [.gitlab-ci.yml](https://gitlab.com/quarmony-free-html/veggie/blob/master/.gitlab-ci.yml) contains a violation of the following CI/CD principle:
