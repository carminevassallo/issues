...
We found that [.gitlab-ci.yml](https://gitlab.com/alvarolopezborr/gitlab-fork-ribbon-css/blob/master/.gitlab-ci.yml) contains a violation of the following CI/CD principle:
