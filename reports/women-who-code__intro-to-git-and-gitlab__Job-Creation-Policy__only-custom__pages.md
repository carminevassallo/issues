...
We found that [.gitlab-ci.yml](https://gitlab.com/women-who-code/intro-to-git-and-gitlab/blob/master/.gitlab-ci.yml) contains a violation of the following CI/CD principle:
