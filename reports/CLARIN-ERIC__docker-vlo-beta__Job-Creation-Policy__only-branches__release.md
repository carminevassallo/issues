...
We found that [.gitlab-ci.yml](https://gitlab.com/CLARIN-ERIC/docker-vlo-beta/blob/master/.gitlab-ci.yml) contains a violation of the following CI/CD principle:
