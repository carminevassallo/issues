...
We found that [.gitlab-ci.yml](https://gitlab.com/harshniketseta/cricket-scorer-ui/blob/master/.gitlab-ci.yml) contains a violation of the following CI/CD principle:
