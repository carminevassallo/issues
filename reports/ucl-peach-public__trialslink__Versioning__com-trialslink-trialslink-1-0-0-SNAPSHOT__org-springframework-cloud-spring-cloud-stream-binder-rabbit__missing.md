...
* org-springframework-cloud-spring-cloud-stream-binder-rabbit (line )

> **Suggested Fix:** Specify the exact version of dependency `org-springframework-cloud-spring-cloud-stream-binder-rabbit`.
