...
We found that [.gitlab-ci.yml](https://gitlab.com/VeraKolotyuk/hexo_examples/blob/master/.gitlab-ci.yml) contains a violation of the following CI/CD principle:
