...
Job tag_with_version is not created when certain new commits are pushed.
...
Job `tag_with_version`, that is defined at line , is set to  be created in stage `` if developers commit changes with some tags
