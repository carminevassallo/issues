...
We found that [.gitlab-ci.yml](https://gitlab.com/breadmaker/universal-html5-audio/blob/master/.gitlab-ci.yml) contains a violation of the following CI/CD principle:
