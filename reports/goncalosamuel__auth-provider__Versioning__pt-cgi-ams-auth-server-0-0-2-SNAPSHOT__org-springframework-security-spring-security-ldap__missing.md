...
* org-springframework-security-spring-security-ldap (line )

> **Suggested Fix:** Specify the exact version of dependency `org-springframework-security-spring-security-ldap`.
