...
We found that [.gitlab-ci.yml](https://gitlab.com/bradanlane/ros-i2cpwmboard/blob/master/.gitlab-ci.yml) contains a violation of the following CI/CD principle:
