...
We found that [.gitlab-ci.yml](https://gitlab.com/isabellesandow/unity4j-meme-generator/blob/master/.gitlab-ci.yml) contains a violation of the following CI/CD principle:
