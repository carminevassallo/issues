...
We found that [.gitlab-ci.yml](https://gitlab.com/gimerstedt/hotkey-overlay-aurelia/blob/master/.gitlab-ci.yml) contains a violation of the following CI/CD principle:
