...
We found that [.gitlab-ci.yml](https://gitlab.com/masterspline/build2-linux-packages/blob/master/.gitlab-ci.yml) contains a violation of the following CI/CD principle:
