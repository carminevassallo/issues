...
We found that [.gitlab-ci.yml](https://gitlab.com/Heyyiou/nuit-de-l-info-not-another-name/blob/master/.gitlab-ci.yml) contains a violation of the following CI/CD principle:
