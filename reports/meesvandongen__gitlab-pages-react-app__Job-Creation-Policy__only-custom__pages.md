...
We found that [.gitlab-ci.yml](https://gitlab.com/meesvandongen/gitlab-pages-react-app/blob/master/.gitlab-ci.yml) contains a violation of the following CI/CD principle:
