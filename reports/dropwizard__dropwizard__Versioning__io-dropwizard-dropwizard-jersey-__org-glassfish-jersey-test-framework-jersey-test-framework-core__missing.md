...
* org-glassfish-jersey-test-framework-jersey-test-framework-core (line )

> **Suggested Fix:** Specify the exact version of dependency `org-glassfish-jersey-test-framework-jersey-test-framework-core`.
