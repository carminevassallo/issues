...
Job sensiolabs-vendor-security-check is not created when certain new commits are pushed.
...
Job `sensiolabs-vendor-security-check`, that is defined at line , is set to  be created in stage `` if developers commit changes to some branches
