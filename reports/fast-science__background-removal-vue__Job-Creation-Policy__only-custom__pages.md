...
We found that [.gitlab-ci.yml](https://gitlab.com/fast-science/background-removal-vue/blob/master/.gitlab-ci.yml) contains a violation of the following CI/CD principle:
