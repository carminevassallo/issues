...
We found that [.gitlab-ci.yml](https://gitlab.com/Crumble/pokemon-shiny-calculator/blob/master/.gitlab-ci.yml) contains a violation of the following CI/CD principle:
