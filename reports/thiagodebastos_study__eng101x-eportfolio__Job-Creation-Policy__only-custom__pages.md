...
We found that [.gitlab-ci.yml](https://gitlab.com/thiagodebastos_study/eng101x-eportfolio/blob/master/.gitlab-ci.yml) contains a violation of the following CI/CD principle:
