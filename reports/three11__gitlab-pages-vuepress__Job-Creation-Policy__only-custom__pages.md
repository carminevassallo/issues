...
We found that [.gitlab-ci.yml](https://gitlab.com/three11/gitlab-pages-vuepress/blob/master/.gitlab-ci.yml) contains a violation of the following CI/CD principle:
