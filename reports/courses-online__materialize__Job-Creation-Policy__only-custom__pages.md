...
We found that [.gitlab-ci.yml](https://gitlab.com/courses-online/materialize/blob/master/.gitlab-ci.yml) contains a violation of the following CI/CD principle:
