...
We found that [.gitlab-ci.yml](https://gitlab.com/territoires/caligram-react/blob/master/.gitlab-ci.yml) contains a violation of the following CI/CD principle:
