...
We found that [.gitlab-ci.yml](https://gitlab.com/axet/android-torrent-client/blob/master/.gitlab-ci.yml) contains a violation of the following CI/CD principle:
