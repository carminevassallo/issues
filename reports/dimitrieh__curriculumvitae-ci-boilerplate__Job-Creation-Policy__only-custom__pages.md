...
We found that [.gitlab-ci.yml](https://gitlab.com/dimitrieh/curriculumvitae-ci-boilerplate/blob/master/.gitlab-ci.yml) contains a violation of the following CI/CD principle:
