...
We found that [.gitlab-ci.yml](https://gitlab.com/sawyerf/Youtube_subscription_manager/blob/master/.gitlab-ci.yml) contains a violation of the following CI/CD principle:
