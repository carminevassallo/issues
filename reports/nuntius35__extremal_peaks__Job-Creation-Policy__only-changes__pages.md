...
We found that [.gitlab-ci.yml](https://gitlab.com/nuntius35/extremal_peaks/blob/master/.gitlab-ci.yml) contains a violation of the following CI/CD principle:
...
Job `pages`, that is defined at line , is set to  be created in stage `` if developers commit changes to the following files only:
