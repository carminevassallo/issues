...
* org-springframework-cloud-spring-cloud-cloudfoundry-connector (line )

> **Suggested Fix:** Specify the exact version of dependency `org-springframework-cloud-spring-cloud-cloudfoundry-connector`.
