...
We found that [.gitlab-ci.yml](https://gitlab.com/uts-magic-lab/react-ros-boilerplate/blob/master/.gitlab-ci.yml) contains a violation of the following CI/CD principle:
