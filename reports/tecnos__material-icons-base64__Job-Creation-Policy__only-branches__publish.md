...
We found that [.gitlab-ci.yml](https://gitlab.com/tecnos/material-icons-base64/blob/master/.gitlab-ci.yml) contains a violation of the following CI/CD principle:
