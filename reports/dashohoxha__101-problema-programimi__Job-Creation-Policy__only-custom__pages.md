...
We found that [.gitlab-ci.yml](https://gitlab.com/dashohoxha/101-problema-programimi/blob/master/.gitlab-ci.yml) contains a violation of the following CI/CD principle:
