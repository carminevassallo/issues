...
* org-springframework-boot-spring-boot-starter-jersey (line )

> **Suggested Fix:** Specify the exact version of dependency `org-springframework-boot-spring-boot-starter-jersey`.
