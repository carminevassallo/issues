...
We found that [.gitlab-ci.yml](https://gitlab.com/rusty-binder/rusty-cheddar/blob/master/.gitlab-ci.yml) contains a violation of the following CI/CD principle:
