...
We found that [.gitlab-ci.yml](https://gitlab.com/marion-deveaud/python-web-apps/blob/master/.gitlab-ci.yml) contains a violation of the following CI/CD principle:
