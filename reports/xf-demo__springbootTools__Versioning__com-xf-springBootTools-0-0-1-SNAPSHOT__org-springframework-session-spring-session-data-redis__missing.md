...
* org-springframework-session-spring-session-data-redis (line )

> **Suggested Fix:** Specify the exact version of dependency `org-springframework-session-spring-session-data-redis`.
