...
We found that [.gitlab-ci.yml](https://gitlab.com/free-electrons-labs/dka-homepage/blob/master/.gitlab-ci.yml) contains a violation of the following CI/CD principle:
