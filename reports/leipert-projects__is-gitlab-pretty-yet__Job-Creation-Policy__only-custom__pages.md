...
We found that [.gitlab-ci.yml](https://gitlab.com/leipert-projects/is-gitlab-pretty-yet/blob/master/.gitlab-ci.yml) contains a violation of the following CI/CD principle:
