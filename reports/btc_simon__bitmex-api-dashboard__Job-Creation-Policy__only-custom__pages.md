...
We found that [.gitlab-ci.yml](https://gitlab.com/btc_simon/bitmex-api-dashboard/blob/master/.gitlab-ci.yml) contains a violation of the following CI/CD principle:
