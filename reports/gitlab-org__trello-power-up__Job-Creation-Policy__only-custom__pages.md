...
We found that [.gitlab-ci.yml](https://gitlab.com/gitlab-org/trello-power-up/blob/master/.gitlab-ci.yml) contains a violation of the following CI/CD principle:
