...
> **Suggested Fix:** Modify ```allow_failure: true``` with ```allow_failure: false``` for job `connected-28-default-x86_64` in [.gitlab-ci.yml](https://gitlab.com/fdroid/fdroidclient/blob/master/.gitlab-ci.yml)
