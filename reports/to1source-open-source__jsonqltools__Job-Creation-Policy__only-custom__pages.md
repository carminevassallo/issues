...
We found that [.gitlab-ci.yml](https://gitlab.com/to1source-open-source/jsonqltools/blob/master/.gitlab-ci.yml) contains a violation of the following CI/CD principle:
