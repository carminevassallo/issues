...
We found that [.gitlab-ci.yml](https://gitlab.com/MaryChelo/data_science_from_scratch/blob/master/.gitlab-ci.yml) contains a violation of the following CI/CD principle:
