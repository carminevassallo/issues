...
We found that [.gitlab-ci.yml](https://gitlab.com/chris-olbrich/emacs-reveal-transaction-processing/blob/master/.gitlab-ci.yml) contains a violation of the following CI/CD principle:
