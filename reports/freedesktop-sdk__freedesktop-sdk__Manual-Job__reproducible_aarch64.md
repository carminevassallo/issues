...
Job reproducible_aarch64 is manually triggered
...
Job `reproducible_aarch64`, that is defined at line  and executed in stage ``, is set to be executed manually.
...
> **Suggested Fix:** Remove ```when:manual``` from the definition of job `reproducible_aarch64`.
