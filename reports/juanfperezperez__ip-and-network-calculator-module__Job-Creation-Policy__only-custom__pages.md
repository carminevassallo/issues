...
We found that [.gitlab-ci.yml](https://gitlab.com/juanfperezperez/ip-and-network-calculator-module/blob/master/.gitlab-ci.yml) contains a violation of the following CI/CD principle:
