...
We found that [.gitlab-ci.yml](https://gitlab.com/victorhck/git_chuleta_comandos/blob/master/.gitlab-ci.yml) contains a violation of the following CI/CD principle:
