...
* org-springframework-boot-spring-boot-starter-amqp (line )

> **Suggested Fix:** Specify the exact version of dependency `org-springframework-boot-spring-boot-starter-amqp`.
