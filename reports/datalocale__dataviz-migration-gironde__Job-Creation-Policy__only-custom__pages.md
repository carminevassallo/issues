...
We found that [.gitlab-ci.yml](https://gitlab.com/datalocale/dataviz-migration-gironde/blob/master/.gitlab-ci.yml) contains a violation of the following CI/CD principle:
