...
We found that [.gitlab-ci.yml](https://gitlab.com/pmercado12/tutorial-git-lab/blob/master/.gitlab-ci.yml) contains a violation of the following CI/CD principle:
