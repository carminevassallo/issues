...
We found that [.gitlab-ci.yml](https://gitlab.com/adrielsantiago/echarts-proof-of-concept/blob/master/.gitlab-ci.yml) contains a violation of the following CI/CD principle:
