...
We found that [.gitlab-ci.yml](https://gitlab.com/swe-nrb/nrb-sbp-shopfront/blob/master/.gitlab-ci.yml) contains a violation of the following CI/CD principle:
