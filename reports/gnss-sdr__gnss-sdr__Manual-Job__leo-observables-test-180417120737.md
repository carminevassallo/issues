...
Job leo-observables-test-180417120737 is manually triggered
...
Job `leo-observables-test-180417120737`, that is defined at line  and executed in stage ``, is set to be executed manually.
...
> **Suggested Fix:** Remove ```when:manual``` from the definition of job `leo-observables-test-180417120737`.
