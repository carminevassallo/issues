...
* org-springframework-boot-spring-boot-starter-validation (line )

> **Suggested Fix:** Specify the exact version of dependency `org-springframework-boot-spring-boot-starter-validation`.
