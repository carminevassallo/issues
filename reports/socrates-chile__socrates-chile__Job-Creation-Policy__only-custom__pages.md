...
We found that [.gitlab-ci.yml](https://gitlab.com/socrates-chile/socrates-chile/blob/master/.gitlab-ci.yml) contains a violation of the following CI/CD principle:
