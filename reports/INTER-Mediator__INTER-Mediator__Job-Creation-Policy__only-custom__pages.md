...
We found that [.gitlab-ci.yml](https://gitlab.com/INTER-Mediator/INTER-Mediator/blob/master/.gitlab-ci.yml) contains a violation of the following CI/CD principle:
