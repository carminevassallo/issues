...
Job mr-test is not created when certain new commits are pushed.
...
Job `mr-test`, that is defined at line , is set to  be created in stage `` if developers commit changes to some branches
