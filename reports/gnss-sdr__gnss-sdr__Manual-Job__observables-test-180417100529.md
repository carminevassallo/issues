...
Job observables-test-180417100529 is manually triggered
...
Job `observables-test-180417100529`, that is defined at line  and executed in stage ``, is set to be executed manually.
...
> **Suggested Fix:** Remove ```when:manual``` from the definition of job `observables-test-180417100529`.
