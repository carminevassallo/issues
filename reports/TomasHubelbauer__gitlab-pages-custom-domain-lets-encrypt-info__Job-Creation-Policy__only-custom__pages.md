...
We found that [.gitlab-ci.yml](https://gitlab.com/TomasHubelbauer/gitlab-pages-custom-domain-lets-encrypt-info/blob/master/.gitlab-ci.yml) contains a violation of the following CI/CD principle:
