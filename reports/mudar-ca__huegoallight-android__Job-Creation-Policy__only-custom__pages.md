...
We found that [.gitlab-ci.yml](https://gitlab.com/mudar-ca/huegoallight-android/blob/master/.gitlab-ci.yml) contains a violation of the following CI/CD principle:
