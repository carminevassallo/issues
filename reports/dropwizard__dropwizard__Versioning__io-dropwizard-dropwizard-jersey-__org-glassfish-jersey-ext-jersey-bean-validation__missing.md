...
* org-glassfish-jersey-ext-jersey-bean-validation (line )

> **Suggested Fix:** Specify the exact version of dependency `org-glassfish-jersey-ext-jersey-bean-validation`.
