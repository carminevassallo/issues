...
We found that [.gitlab-ci.yml](https://gitlab.com/ZeroDot1/CoinBlockerLists/blob/master/.gitlab-ci.yml) contains a violation of the following CI/CD principle:
