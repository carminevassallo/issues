...
We found that [.gitlab-ci.yml](https://gitlab.com/gableroux/unity3d-gitlab-ci-example/blob/master/.gitlab-ci.yml) contains a violation of the following CI/CD principle:
