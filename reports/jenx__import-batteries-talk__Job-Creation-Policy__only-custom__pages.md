...
We found that [.gitlab-ci.yml](https://gitlab.com/jenx/import-batteries-talk/blob/master/.gitlab-ci.yml) contains a violation of the following CI/CD principle:
