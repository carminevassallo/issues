...
We found that [.gitlab-ci.yml](https://gitlab.com/grahamc/mac-nix-multi-user/blob/master/.gitlab-ci.yml) contains a violation of the following CI/CD principle:
