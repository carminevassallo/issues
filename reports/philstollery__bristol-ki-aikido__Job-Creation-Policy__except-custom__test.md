...
We found that [.gitlab-ci.yml](https://gitlab.com/philstollery/bristol-ki-aikido/blob/master/.gitlab-ci.yml) contains a violation of the following CI/CD principle:
