...
We found that [.gitlab-ci.yml](https://gitlab.com/swe-nrb/demo-infopack-rollbeskrivningar/blob/master/.gitlab-ci.yml) contains a violation of the following CI/CD principle:
