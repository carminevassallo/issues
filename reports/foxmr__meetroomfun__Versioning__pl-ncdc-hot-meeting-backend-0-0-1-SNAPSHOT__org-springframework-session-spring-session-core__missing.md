...
* org-springframework-session-spring-session-core (line )

> **Suggested Fix:** Specify the exact version of dependency `org-springframework-session-spring-session-core`.
